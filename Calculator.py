...
btn_clear = tk.Button(root, text="AC", command=lambda: clear_field(), width = 5, font = ("Arial", 14))
btn_clear.grid(row=6, column=1)
btn_equal =tk.Button(root, text="=", command=lambda: evaluate_calculation(), width = 11, font = ("Arial", 14))
